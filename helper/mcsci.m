function [out str] = mcsci(x,y,varargin)
...
% 	nSamples = number of MCS comparsions (def: 100)
%
% RQACI-options:
...
%% I/O check
if (nargchk(2,10,nargin)), help(mfilename),return; end
...
for iSample = 1:nSamples
	...
	[valA ciA] = rqaci(squeeze(allRPsX(trialsX(iSample),:,:)),nBoot,alpha,theiler,minL,minV);
	[valB ciB] = rqaci(squeeze(allRPsY(trialsY(iSample),:,:)),nBoot,alpha,theiler,minL,minV);
